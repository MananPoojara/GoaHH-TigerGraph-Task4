...
Priority is strict: P0 blocks the official cases, P1 completes the judged product, P2 improves innovation only after all release gates pass.
...
- [ ] Offline shared-origin ring discovery using components/community features.
- [ ] Emerging-pattern clustering and analyst naming workflow.
- [ ] Autonomous risk-score monitoring with separate outputs.
- [ ] Calibration comparison and uncertainty dashboard.
- [ ] Hosted multi-user deployment with authenticated MCP gateway.

## Work item definition

Every item must name its input, output, failure behavior, test/verification evidence, and observable user value. “Implemented” is not complete until the relevant release gate passes.
